...
function createRow(province, town, name, day_index, menu_index,){
  return {
    ...
    "対象学年": "小学校中学年",
    "レコードID": 1,
    "提供年月日": dayjs().add(day_index, 'd').format('YYYY-MM-DD'),
    "献立ID": 1,
    "料理ID": menu_index,
    ...
    "食品群（６群）": foodArr[menu_index].food_group_6,
    "食品群（３群）": foodArr[menu_index].food_group_3,
    "分量": getRandomInt(1000),
    "エネルギー": getRandomInt(1000),
    "たんぱく質": getRandomInt(100)/10,
    "たんぱく質エネルギー比": "",
